...
export const wins: Win[] = [
  ...
  makeWin('w2', 'sweet-bonanza', 'M***na', 'Dragon Money', 'dragon-money', '345 600 ₽', 'Сегодня, 12:11'),
  ...
  makeWin('w17', 'the-dog-house', 'G***ry', 'Dragon Money', 'dragon-money', '188 400 ₽', 'Сегодня, 08:52'),
  makeWin('w5', 'wolf-gold', 'D***ev', 'Dragon Money', 'dragon-money', '176 300 ₽', 'Вчера, 22:08'),
  makeWin('w6', 'sugar-rush', 'L***ko', 'Dragon Money', 'dragon-money', '154 900 ₽', 'Вчера, 20:40'),
  makeWin('w7', 'starlight-princess', 'P***rt', 'Dragon Money', 'dragon-money', '143 200 ₽', 'Вчера, 18:15'),
  makeWin('w8', 'fruit-party', 'T***sk', 'Dragon Money', 'dragon-money', '128 700 ₽', 'Вчера, 16:54'),
  makeWin('w9', 'reactoonz', 'R***na', 'Dragon Money', 'dragon-money', '99 400 ₽', 'Вчера, 15:12'),
  makeWin('w10', 'money-train-3', 'N***el', 'Dragon Money', 'dragon-money', '91 800 ₽', '17 июня, 21:30'),
  makeWin('w11', 'aviator', 'V***or', 'Dragon Money', 'dragon-money', '86 200 ₽', '17 июня, 19:44'),
