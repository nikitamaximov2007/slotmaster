...
const rankingFaq = [
  ...
  {
    question: 'Включает ли рейтинг бонусные предложения?',
    answer:
      'Да, на страницах есть бонусные предложения казино. Это не влияет на позиции: рейтинг определяется методикой SlotMaster.',
  },
  {
